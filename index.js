...
const formatReadme = (data) => {
  ...
  formattedReadme.push('# TradingView BNBUSD Scanner (1H)')
  ...
  formattedReadme.push('BNBUSD recommendation scanner based on real-time TradingView data Scanner API')
...
const main = async () => {
  try {
    ...
    await fs.writeJson('databnb.json', { updated: formattedDate, data }, { spaces: 2 })
